...
// sections
import { UserListHead, UserListToolbar, UserMoreMenu } from '../../../sections/@dashboard/avanses/list';
...
const TABLE_HEAD = [
  ...
  { id: 'role', label: 'Контрагент', alignRight: false },
...
export default function UserList() {
  ...
  useEffect(()=> {
    ...
    fetch(`${process.env.NEXT_PUBLIC_HOST}/avanse`)
    .then(res => res.json())
    .then(json => {
      console.log(json)
      setList(json)
    ...
    <Page title="Авансы">
      <Container maxWidth={themeStretch ? false : 'lg'}>
        <HeaderBreadcrumbs
          ...
          action={
            <NextLink href={PATH_DASHBOARD.avanses.new} passHref>
