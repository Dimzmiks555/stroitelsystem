    ...
    try {
      ...
      if (!isEdit) {
        ...
        data = {
          ...
          summ: +values.summ,
          contragent_id: values.buyer?.value,
        ...
        console.log(data)
        fetch(`${process.env.NEXT_PUBLIC_HOST}/avanse/${query?.id}`, {
          method: 'PATCH',
          headers: {
            'Content-Type': 'application/json',
            Accept: 'application/json',
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                          <Autocomplete
                            ...
                            renderInput={(params) => <TextField label="Контрагент" {...params} sx={{width: '320px', mb: 4}} />}
                          />
                        )}
                      />
                  {isEdit && (
                  ...
                  <Card sx={{p: 2}}>
                    <Table >
                      <TableRow>
                        ...
                        <TableCell>{currentProduct?.contragent?.name}</TableCell>
                      </TableRow>
                      {/* <TableRow>
